<template>
  <div>
    ...
    <!--示例JSON-->
    <div
      style="text-align: left; min-width: 350px; max-width: 40%; float: left; margin-left: 20%"
    >
      JSON格式：
      <pre style="font-family: 'Source Code Pro', monospace;">
  {
    ...
    link: string;
      ...
      查看示例JSON：<a
        href="https://wensun.top:8080/oasis-help/test.json"
        target="_blank"
        >test.json</a
      >
    </div>
  ...
  link
      ...
      查看示例CSV：<a
        href="https://wensun.top:8080/oasis-help/result.csv"
        target="_blank"
        >result.csv</a
      >
    </div>
